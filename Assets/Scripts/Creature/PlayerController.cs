...
public class PlayerController : StateMachine<PlayerController>
{
    ...
    private void Start()
    {
        ...
        MainManager.I.gameUI.InitialzeHpSlider(hp);
        maxStamina = stamina;
        MainManager.I.gameUI.InitializeStaminaSlider(maxStamina);
    ...
    public void OnDamage(int damage)
    {
        ...
        hp -= damage;
        MainManager.I.gameUI.SetHpSlider(hp);
    ...
    private class IdleState : State<PlayerController>
    {
        ...
        public override void OnUpdate()
        {
            ...
            MainManager.I.gameUI.SetStaminaSlider(m.stamina);
